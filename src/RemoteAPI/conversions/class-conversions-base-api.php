 ...
 */
abstract class Conversions_Base_API extends Base_Endpoint_Remote {
	...
	public function get_api_url( array $query = array() ): string {
		...
		$query['secret'] = $this->parsely->get_conversions_api_secret();
		$query['url'] = 'https://wpvip.com/contact';
	 ...
	 *                         object in case of a successful request.
	 */
	protected function get_request( array $query = array(), array $body = array() ) {
