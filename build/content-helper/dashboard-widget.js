...
function TopPosts() {
  ...
  var trackFilterChanges = function (filter, props) {
    _js_telemetry_telemetry__WEBPACK_IMPORTED_MODULE_8__["default"].trackEvent('dash_widget_filter_changed', __assign({
      filter: filter
    }, props));
  };
  ...
  var navigation = (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
    ...
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("button", {
      ...
      onClick: function () {
        setPage(page - 1);
        _js_telemetry_telemetry__WEBPACK_IMPORTED_MODULE_8__["default"].trackEvent('dash_widget_navigation', {
          navigation: 'previous',
          to_page: page - 1
        });
      },
