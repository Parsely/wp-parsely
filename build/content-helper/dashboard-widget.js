...
/* harmony import */ var _common_select__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../common/select */ "./src/content-helper/common/select.tsx");
/* harmony import */ var _common_settings__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../common/settings */ "./src/content-helper/common/settings/index.ts");
...
/* harmony import */ var _provider__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../provider */ "./src/content-helper/dashboard-widget/provider.ts");
/* harmony import */ var _top_posts_list_item__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./top-posts-list-item */ "./src/content-helper/dashboard-widget/components/top-posts-list-item.tsx");
var __assign = undefined && undefined.__assign || function () {
  __assign = Object.assign || function (t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
      s = arguments[i];
...
function TopPosts() {
  var _this = this;
  var _a = (0,_common_settings__WEBPACK_IMPORTED_MODULE_6__.useSettings)(),
  ...
  var _d = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)([]),
    posts = _d[0],
    setPosts = _d[1];
  var _e = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(1),
    page = _e[0],
    setPage = _e[1];
  /**
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(function () {
    var provider = _provider__WEBPACK_IMPORTED_MODULE_8__.DashboardWidgetProvider.getInstance();
    var fetchPosts = function (retries) {
      return __awaiter(_this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
          provider.getTopPosts(settings, page).then(function (result) {
            setPosts(result);
            setLoading(false);
          }).catch(function (err) {
            return __awaiter(_this, void 0, void 0, function () {
  ...
  var trackFilterChanges = function (filter, props) {
    _js_telemetry_telemetry__WEBPACK_IMPORTED_MODULE_4__.Telemetry.trackEvent('dash_widget_filter_changed', __assign({
      filter: filter
    }, props));
  };
  var filters = (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
    className: "parsely-top-posts-filters",
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_common_select__WEBPACK_IMPORTED_MODULE_5__.Select, {
      defaultValue: settings.Period,
      items: Object.values(_common_utils_constants__WEBPACK_IMPORTED_MODULE_7__.Period).map(function (value) {
        return [value, (0,_common_utils_constants__WEBPACK_IMPORTED_MODULE_7__.getPeriodDescription)(value)];
      }),
      onChange: function (event) {
        if ((0,_common_utils_constants__WEBPACK_IMPORTED_MODULE_7__.isInEnum)(event.target.value, _common_utils_constants__WEBPACK_IMPORTED_MODULE_7__.Period)) {
          setSettings({
    ...
    }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_common_select__WEBPACK_IMPORTED_MODULE_5__.Select, {
      defaultValue: settings.Metric,
      items: Object.values(_common_utils_constants__WEBPACK_IMPORTED_MODULE_7__.Metric).map(function (value) {
        return [value, (0,_common_utils_constants__WEBPACK_IMPORTED_MODULE_7__.getMetricDescription)(value)];
      }),
      onChange: function (event) {
        if ((0,_common_utils_constants__WEBPACK_IMPORTED_MODULE_7__.isInEnum)(event.target.value, _common_utils_constants__WEBPACK_IMPORTED_MODULE_7__.Metric)) {
          setSettings({
  ...
  var navigation = (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
    ...
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("button", {
      ...
      disabled: page <= 1,
      "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Previous page', 'wp-parsely'),
      onClick: function () {
        setPage(page - 1);
        _js_telemetry_telemetry__WEBPACK_IMPORTED_MODULE_4__.Telemetry.trackEvent('dash_widget_navigation', {
          navigation: 'previous',
          to_page: page - 1
        });
      },
      ...
      disabled: !loading && posts.length < _provider__WEBPACK_IMPORTED_MODULE_8__.TOP_POSTS_DEFAULT_LIMIT,
      "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Next page', 'wp-parsely'),
      onClick: function () {
        setPage(page + 1);
        _js_telemetry_telemetry__WEBPACK_IMPORTED_MODULE_4__.Telemetry.trackEvent('dash_widget_navigation', {
          navigation: 'next',
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [filters, loading ? spinner : (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("ol", {
      ...
      style: {
        counterReset: 'item ' + (page - 1) * _provider__WEBPACK_IMPORTED_MODULE_8__.TOP_POSTS_DEFAULT_LIMIT
      },
      children: posts.map(function (post) {
        return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_top_posts_list_item__WEBPACK_IMPORTED_MODULE_9__.TopPostListItem, {
          metric: settings.Metric,
          post: post
        }, post.id);
      })
    }), (posts.length >= _provider__WEBPACK_IMPORTED_MODULE_8__.TOP_POSTS_DEFAULT_LIMIT || page > 1) && navigation]
  });
}
...
var DashboardWidgetProvider = /** @class */function (_super) {
  __extends(DashboardWidgetProvider, _super);
   ...
   */
  DashboardWidgetProvider.getInstance = function () {
    if (!this.instance) {
   ...
   */
  DashboardWidgetProvider.prototype.getTopPosts = function (settings_1) {
    return __awaiter(this, arguments, void 0, function (settings, page) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            _a.trys.push([1, 3,, 4]);
            return [4 /*yield*/, this.fetchTopPostsFromWpEndpoint(settings, page)];
          case 2:
            data = _a.sent();
            return [3 /*break*/, 4];
          case 3:
          ...
          case 4:
            if (0 === data.length) {
              return [2 /*return*/, Promise.reject(new _common_content_helper_error__WEBPACK_IMPORTED_MODULE_3__.ContentHelperError((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('No Top Posts data is available.', 'wp-parsely'), _common_content_helper_error__WEBPACK_IMPORTED_MODULE_3__.ContentHelperErrorCode.ParselyApiReturnedNoData, ''))];
            }
   ...
   */
  DashboardWidgetProvider.prototype.fetchTopPostsFromWpEndpoint = function (settings, page) {
    return __awaiter(this, void 0, void 0, function () {
      var response;
      return __generator(this, function (_a) {
        response = this.fetch({
          path: (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_1__.addQueryArgs)('/wp-parsely/v2/stats/posts/', __assign(__assign({
            limit: TOP_POSTS_DEFAULT_LIMIT
          }, (0,_common_utils_api__WEBPACK_IMPORTED_MODULE_4__.getApiPeriodParams)(settings.Period)), {
...
var getSettingsFromJson = function (settingsJson) {
  ...
  try {
    ...
    return {
      Metric: _common_utils_constants__WEBPACK_IMPORTED_MODULE_5__.Metric.Views,
      Period: _common_utils_constants__WEBPACK_IMPORTED_MODULE_5__.Period.Days7
    };
  }
  // Fix invalid values if any are found.
  if (!(0,_common_utils_constants__WEBPACK_IMPORTED_MODULE_5__.isInEnum)(parsedSettings === null || parsedSettings === void 0 ? void 0 : parsedSettings.Metric, _common_utils_constants__WEBPACK_IMPORTED_MODULE_5__.Metric)) {
    parsedSettings.Metric = _common_utils_constants__WEBPACK_IMPORTED_MODULE_5__.Metric.Views;
  }
  if (!(0,_common_utils_constants__WEBPACK_IMPORTED_MODULE_5__.isInEnum)(parsedSettings === null || parsedSettings === void 0 ? void 0 : parsedSettings.Period, _common_utils_constants__WEBPACK_IMPORTED_MODULE_5__.Period)) {
    parsedSettings.Period = _common_utils_constants__WEBPACK_IMPORTED_MODULE_5__.Period.Days7;
  }
...
window.addEventListener('load', function () {
  ...
  if (null !== container) {
    var component = (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_common_settings__WEBPACK_IMPORTED_MODULE_4__.SettingsProvider, {
    ...
    if (_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createRoot) {
      ...
      (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.render)(component, container);
    }
  }
}, false);
}();
