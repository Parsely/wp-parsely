...
/* harmony import */ var _provider__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../provider */ "./src/content-helper/excerpt-generator/provider.ts");
...
var PostExcerptGenerator = function () {
  ...
  var excerptGeneratorProvider = new _provider__WEBPACK_IMPORTED_MODULE_10__.ExcerptGeneratorProvider();
        ...
        switch (_b.label) {
          case 0:
            ...
            return [4 /*yield*/, _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default()({
              method: 'POST',
              path: (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_1__.addQueryArgs)('/wp-parsely/v1/content-suggestions/suggest-brief', {
                title: title
              }),
              data: {
                content: content
