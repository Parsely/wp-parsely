...
/* harmony import */ var _content_helper_common_utils_functions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../content-helper/common/utils/functions */ "./src/content-helper/common/utils/functions.ts");
/* harmony import */ var _telemetry__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./telemetry */ "./src/js/telemetry/telemetry.ts");
...
var BlockChangeMonitor = function () {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    ...
    var initialize = function () {
      var previousBlocks = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)('core/block-editor').getBlocks();
      /**
      ...
      var checkBlocks = function () {
        var currentBlocks = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.select)('core/block-editor').getBlocks();
        ...
        addedBlocks.forEach(function (block) {
          if (block.name.startsWith(parselyBlockPrefix)) {
            _telemetry__WEBPACK_IMPORTED_MODULE_4__.Telemetry.trackEvent('block_added', {
              block: block.name
            });
          }
        });
        ...
        removedBlockIds.forEach(function (id) {
          ...
          if (removedBlock && removedBlock.name.startsWith(parselyBlockPrefix)) {
            _telemetry__WEBPACK_IMPORTED_MODULE_4__.Telemetry.trackEvent('block_removed', {
      ...
      unsubscribe = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_0__.subscribe)(debouncedCheckBlocks, 'core/block-editor');
      return unsubscribe;
    };
    // Initialize the block change monitor when the editor is ready.
    (0,_content_helper_common_utils_functions__WEBPACK_IMPORTED_MODULE_3__.isEditorReady)().then(initialize);
    return function () {
      if (unsubscribe) {
        unsubscribe();
      }
