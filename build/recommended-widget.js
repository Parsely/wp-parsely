...
/* harmony import */ var _lib_personalization__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../lib/personalization */ "./src/js/lib/personalization.js");
...
function widgetLoad(_ref) {
  ...
  var fullUrl = apiUrl;
  var uuid = personalized ? (0,_lib_personalization__WEBPACK_IMPORTED_MODULE_3__.getUuidFromVisitorCookie)() : undefined;

  if (uuid) {
    fullUrl += "&uuid=".concat(encodeURIComponent(uuid));
  } else {
    fullUrl += "&url=".concat(encodeURIComponent(permalink));
  }

  var parentDiv = document.querySelector("#".concat(widgetId));
...
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_2___default()(function () {
  var _global = __webpack_require__.g,
      wpParselyRecommended = _global.wpParselyRecommended;
  widgetLoad(_objectSpread({}, wpParselyRecommended));
});
}();
/******/ })()
;
