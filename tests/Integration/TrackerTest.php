...
final class TrackerTest extends TestCase {
	 ...
	 *
	 * @covers \Parsely\Tracker::register_scripts
	 ...
	 *
	 * @covers \Parsely\Tracker::enqueue_js_tracker
	 * @uses \Parsely\Parsely::get_asset_cache_buster
	 * @uses \Parsely\Parsely::api_key_is_missing
	 * @uses \Parsely\Parsely::api_key_is_set
	 * @uses \Parsely\Parsely::get_options
	 ...
	 * @uses \Parsely\Parsely::update_metadata_endpoint
	 * @uses \Parsely\Tracker::register_scripts
	...
	public function test_load_js_tracker(): void {
		...
		$this->go_to( '/?p=' . $post );
		self::$tracker->register_scripts();
		self::$tracker->enqueue_js_tracker();
	 ...
	 *
	 * @covers \Parsely\Tracker::enqueue_js_api
	 * @uses \Parsely\Parsely::api_key_is_missing
	 * @uses \Parsely\Parsely::api_key_is_set
	 * @uses \Parsely\Parsely::get_asset_cache_buster
	 * @uses \Parsely\Parsely::get_options
